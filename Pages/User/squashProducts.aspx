<%@ Page Title="Squash Products" Language="C#"
    MasterPageFile="~/Master_Pages/Site.Master"
    AutoEventWireup="true"
    CodeBehind="squashProducts.aspx.cs"
    Inherits="SmashZone.Pages.User.squashProducts" %>
...
<style>
    ...
    .p-card:hover { transform: translateY(-2px); box-shadow: 0 10px 22px rgba(0,0,0,.08); }

    .p-img-wrap{
        height: 220px; padding: 18px;
...
<h2 class="mb-3">Squash Products</h2>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div class="card p-card h-100">
                            ...
                            <div class="p-img-wrap">
                                <img src='<%# ResolveUrl("~/" + Eval("ProductImage")) %>' class="p-img" alt="Product" />
                            </div>
